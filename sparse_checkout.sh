...
git_folder_location='/home/<yourname>/mlopsv2root'   #replace with the local root folder location where you want to create the project folder
project_name=mlopsv2-sparse   #replace with your project name
github_org_name=blr-reactor   #replace with your github org name
project_template_github_url=https://github.com/blr-reactor/mlops-project-template   #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
